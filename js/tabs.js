...
let tabsTarif = document.querySelectorAll('.slider-tarif-container div')
let allTarifSliders = document.querySelectorAll('.slider-tarif')
    ...
    tabsTarif.forEach(el => {
        el.addEventListener('click', () => {
            let neededSlider = document.querySelector(`.goods__slider[data-goods="${el.getAttribute('data-tarif')}"]`);
            neededSlider.style.visibility = 'visible'
